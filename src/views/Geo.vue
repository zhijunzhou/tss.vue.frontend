  ...
  <div class="page-content">
    <div class="amap-page-container">
      <el-amap vid="amapDemo" :amap-manager="amapManager" :zoom="zoom" :plugin="plugin" :events="events">
        ...
        <el-amap-ground-image v-for="groundimage in groundimages" :key="groundimage.url" :url="groundimage.url" :bounds="groundimage.bounds" :events="groundimage.events"></el-amap-ground-image>
      </el-amap>
