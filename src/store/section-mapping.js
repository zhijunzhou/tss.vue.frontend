export default {
  '9901': {
    'title': 'Solution Status Report',
    'fullTitle': 'Solution Status Report',
    'name': 'soln-status-report-data',
    'path': 'opptyOverview.solnStatusReptData'
  },
  '9902': {
    'title': 'Solution Status Report',
    'fullTitle': 'Solution Status Report',
    'name': 'soln-status-report-disp',
    'path': 'opptyOverview.solnStatusReptDisp'
  },
  '0201': {
  ...
  '020801': {
    'title': 'Other Client Parameters',
    'fullTitle': 'Other Client Parameters',
    'name': 'other-client-parameters',
    'path': 'clientViewpoint.otherClientParameters'
  },
  '030101': {
  ...
  '030302': {
    'title': 'Transformation Themes Mapping',
    'fullTitle': 'Transformation Themes Mapping',
  ...
  '040302': {
    'title': 'Work Placement Targets',
    'fullTitle': 'Service and Hardware Work Placement Targets',
  ...
  '040307': {
    ...
    'fullTitle': 'Key Deliverables and Milestones (Project Offerings Only)',
    'name': 'key-deliverables-milestones',
    'path': 'solnDesign.svcSoln.keyDeliverablesMilestones'
  },
  '040308': {
    'title': 'Effort Estimation',
    'fullTitle': 'Effort Estimation (Project Offerings Only)',
  ...
  '040203': {
    'title': 'DXC Requirements',
    'fullTitle': 'DXC Requirements',
